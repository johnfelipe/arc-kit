...
2. If the user provided `{{input_architecture_docs}}` with a specific focus (e.g., "procurement", "governance review"), use that as context during triage — it may let you skip some questions
