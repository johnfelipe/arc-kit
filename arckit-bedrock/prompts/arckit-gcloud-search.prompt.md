...
Before writing the file, read `{{references_quality_checklist}}` and verify all **Common Checks** plus the **GCLD** per-type checks pass. Fix any failures before proceeding.
